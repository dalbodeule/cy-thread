...
// 한 번에 export
const tables = {
    users, oauthAccounts, forums, forumAdmins, forumFollowers, forumBans,
    categories, categoryAdmins, threads, posts, attachments, sessions
};

const relationsAll = [
    usersRelations, oauthAccountsRelations, forumsRelations, forumAdminsRelations,
    forumFollowersRelations, forumBansRelations, categoriesRelations, categoryAdminsRelations,
    threadsRelations, postsRelations, attachmentsRelations, sessionsRelations
] as const;
